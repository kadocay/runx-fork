...
| `openapi-graph` + `openapi-tool` | OpenAPI via external-adapter (an OpenAPI operation executed as a governed call) | `sh examples/openapi-graph/run.sh` (real call against a local fixture) |
